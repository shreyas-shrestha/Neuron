        ...
        <div className="px-6 py-5 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-end gap-3 max-w-2xl">
            <label className="flex-1 block min-w-0">
              ...
              <input
                className="input-neuron mt-1.5 font-sans text-[14px] w-full"
                value={label}
            ...
            <button
              ...
              onClick={() => gen.mutate()}
              className="btn-primary text-[13px] min-h-[44px] px-5 shrink-0 w-full sm:w-auto"
            >
      ...
      {modalOpen &&
        ...
        createPortal(
          ...
          >
            ...
            >
              <h3 id="new-key-modal-title" className="font-display font-semibold text-[18px] text-neuron-primary">
